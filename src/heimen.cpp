...
seg.setInputCloud(input_cloud.makeShared()); //入力点群をセット
...
for (size_t i = 0; i < inliers->indices.size (); ++i) 
{
  ...
  points_pub.publish(*coefficients);*/
...
{
  ros::init(argc, argv, "heimen");
  ros::NodeHandle nh;
  points_pub = nh.advertise<sensor_msgs::PointCloud2> ("/heimen_points", 1000);
