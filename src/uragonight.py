...
cv2.createTrackbar("R_max", "OpenCV Window", 255, 255, nothing)     # Hueの最大値は179
cv2.createTrackbar("G_min", "OpenCV Window", 0, 255, nothing)
cv2.createTrackbar("G_max", "OpenCV Window", 50, 255, nothing)
cv2.createTrackbar("B_min", "OpenCV Window", 0, 255, nothing)
cv2.createTrackbar("B_max", "OpenCV Window", 100, 255, nothing)
cv2.createTrackbar("threshold", "OpenCV Window", 120, 255, nothing)
